...
window.addEventListener('load', ()=> {
    Swal.fire({
        ...
        imageHeight: 267,
        input: "text",
        inputLabel: "Di tahun ini (2023), pada tanggal berapa kita bertemu lagi untuk pertama kali?",
        showCancelButton: false,
        inputValidator: (value) => {
          if (value.toLowerCase() != '4 maret 2023') {
            return "Ups, Salah 😝, ingat, hari  bulan tahun wkwk";
          }
